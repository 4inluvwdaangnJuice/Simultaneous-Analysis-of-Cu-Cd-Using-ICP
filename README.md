...
분석법의 적용 예시는 원리 설명을 위한 가상 데이터이며 실제 실험 결과와 구분한다.

<p align="center"><a href="assets/report/image1.jpeg"><img src="assets/report/image1.jpeg" alt="가천대학교 로고" width="160" style="max-width:100%;height:auto;"></a></p>

## 조원 및 역할

| 학과 | 학번 | 이름 | 역할 |
| --- | --- | --- | --- |
| 화공생명배터리공학과 | 202333357 | 김태현 | 레포트 제작 |
| 화공생명배터리공학과 | 202333362 | 송주엽 | 자료 조사 |
| 화공생명배터리공학과 | 202333365 | 염진호 | 레포트 제작 |
| 화공생명배터리공학과 | 202333375 | 이정민 | 발표 |
| 화공생명배터리공학과 | 202333384 | 조준희 | PPT 제작 |
...
**계산:** S = 100C → C = 250 / 100 = **2.5 mg/L**. 실제 검량식은 절편을 포함한 S = mC + b로 적합한다.
...
**계산:** S = 80C첨가 + 160. x절편 −2 mg/L의 절댓값은 최종 측정용액에서 시료가 기여한 농도다. 시료 10 mL를 20 mL로 정용했으므로 첨가 전 미지시료 농도는 2 × (20 / 10) = **4 mg/L**다.
...
아래는 발표자가 사용한 웹 자료 목록을 읽기 쉽게 정리한 목록이다. EPA 등 보충 자료와 구분하여 표시한다. 링크의 검색 추적 정보와 본문 강조용 문자열은 제외했다.
...
발표자료에 기재된 네이버 지식백과 주소는 문서 식별 정보가 완전하지 않아 정확한 항목을 특정할 수 없다. 잘못된 링크를 임의로 연결하지 않았다. 영상 및 웹 그림의 개별 원출처는 해당 페이지에서 확인해야 한다.
